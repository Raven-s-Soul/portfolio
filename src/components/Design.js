          ...
          <div className='container'>
            ...
            <div className='row g-3'>
              ...
              <div className="col-12 col-md-6 col-lg-4" >
                    ...
                    <div className="card" >
                        <img src={blockudoku} loading="lazy" className="card-img-top" alt="..."/>
              ...
              <div className="col-12 col-md-6 col-lg-4" >
                  ...
                  <div className="card" >
                      <img src={fps} loading="lazy" className="card-img-top" alt="..."/>
                      <div className="card-body">
              ...
              <div className="col-12 col-md-6 col-lg-4" >
                  ...
                  <div className="card" >
                      <img src={rpg} loading="lazy" className="card-img-top" alt="..."/>
                      <div className="card-body">
              ...
              <div className="col-12 col-md-6 col-lg-4" >
                  ...
                  <div className="card" >
                      <img src={rts} loading="lazy" className="card-img-top" alt="..."/>
                      <div className="card-body">
              ...
              <div className="col-12 col-md-6 col-lg-4" >
                  ...
                  <div className="card" >
                      <img src={uncertainties} loading="lazy" className="card-img-top" alt="..."/>
                      <div className="card-body">
