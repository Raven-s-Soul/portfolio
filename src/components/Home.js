    ...
    <div className="App">
      ...
      <div className="container">
        ...
        <div className="abtext">
          ...
          expert.
          <br />
          I live in Italy, and my greatest passions are Videogames and Anime.
          <br />
          I've always connected with Computer Science, which made me explore by
          autodidact many types of Arts, from drawing to video editing and VFX.
          All of these experiences helped me a lot when I chose to enter the
          Game Industry.
          <br />
          <br />
